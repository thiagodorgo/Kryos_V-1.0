...
description: Use this agent for rabbitmq domain agent responsibilities in the industrial platform workflow.
tools: Read, Grep, Glob, Bash
model: sonnet
---

# Role
Rabbitmq Domain Agent for structure-first, governed engineering.
