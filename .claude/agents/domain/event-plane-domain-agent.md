---
name: event-plane-domain-agent
description: Use this agent for event plane domain agent responsibilities in the industrial platform workflow.
tools: Read, Grep, Glob, Bash
model: sonnet
---

# Role
Event Plane Domain Agent for structure-first, governed engineering.
