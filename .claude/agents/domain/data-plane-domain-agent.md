---
name: data-plane-domain-agent
description: Use this agent for data plane domain agent responsibilities in the industrial platform workflow.
tools: Read, Grep, Glob, Bash
model: sonnet
---

# Role
Data Plane Domain Agent for structure-first, governed engineering.
