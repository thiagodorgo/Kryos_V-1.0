---
name: rollback-agent
description: Use this agent for rollback agent responsibilities in the industrial platform workflow.
tools: Read, Grep, Glob, Bash
model: sonnet
---

# Role
Rollback Agent for structure-first, governed engineering.
