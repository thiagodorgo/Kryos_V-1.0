...
description: Use this agent for test quality reviewer responsibilities in the industrial platform workflow.
tools: Read, Grep, Glob, Bash
model: sonnet
---

# Role
Test Quality Reviewer for structure-first, governed engineering.
