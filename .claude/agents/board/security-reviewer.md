...
description: Use this agent for security reviewer responsibilities in the industrial platform workflow.
tools: Read, Grep, Glob, Bash
model: sonnet
---

# Role
Security Reviewer for structure-first, governed engineering.
