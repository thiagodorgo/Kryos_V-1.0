var project = {"languages":{"de":"Deutsch","en":"English"},"extensions":{"SYSTEM.GLOBALS.CAREL.QUICKDYNAMICS.Slide":[function(base,webMI,window,document,self){
...
"SYSTEM.GLOBALS.CAREL.QUICKDYNAMICS.index":[function(base,webMI,window,document,self){
...
"SYSTEM.LIBRARY.ATVISE.QUICKDYNAMICS.Move":[function(base,webMI,window,document,self){
...
if (!this.initialized || !base.defaultconfiguration) {
	this.activated = base.activated == "true";
...
setInterval(function() {
	...
	if (seconds >=  self.interval) {
		...
		checkServerState(handleServerState);
	} else {
		++seconds;
	}
}, 1000);
...
function checkServerState(callback) {
	xmlHttp.open("GET", "/?cachebreaker=" + new Date().getTime(), true);
...
"SYSTEM.GLOBALS.CAREL.QUICKDYNAMICS.Rotation on/off":[function(base,webMI,window,document,self){
var curStep = 0;
var timer;
...
"SYSTEM.GLOBALS.CAREL.QUICKDYNAMICS.Node Description":[function(base,webMI,window,document,self){
...
"SYSTEM.LIBRARY.CAREL.QUICKDYNAMICS.Open Device Page":[function(base,webMI,window,document,self){
webMI.addEvent(base.id, "click", function(e) {
var passObj = {};
passObj["base"] = base.addrbase;
webMI.display.openDisplay(base.display, passObj);
});
},{}],
...
document.getElementById(base.id).setAttributeNode(att);
// *******************************************
...
"SYSTEM.GLOBALS.CAREL.QUICKDYNAMICS.Open PopUp Display":[function(base,webMI,window,document,self){
...
"SYSTEM.GLOBALS.CAREL.QUICKDYNAMICS.Enable Access Right":[function(base,webMI,window,document,self){
...
"SYSTEM.LIBRARY.PROJECT.QUICKDYNAMICS.Open Modal Display":[function(base,webMI,window,document,self){
...
if(base.position=="mouse top-right")
{
	xpos = xpos - base.width;
}
if(base.position=="mouse bottom-right")
{
	xpos = xpos - base.width;
	ypos = ypos - base.height;
}
if(base.position=="mouse bottom-left")
{
		ypos = ypos - base.height;
}

webMI.display.openWindow({display:base.display,extern:false,height:base.height,menubar:false,modal:false,movable:true,resizable:true,scrollbars:false,status:false,title:"",toolbar:true,width:base.width,x:xpos,y:ypos,query:webMI.query});
});
},{"height":"350","width":"350"}],
"SYSTEM.GLOBALS.CAREL.QUICKDYNAMICS.Open Display on Frame":[function(base,webMI,window,document,self){
...
"SYSTEM.GLOBALS.CAREL.QUICKDYNAMICS.PVPRO_boss Alarms List":[function(base,webMI,window,document,self){
// ***** applying style="cursor:pointer" *****
webMI.addEvent(base.id, "mouseover", function(e)
{
	document.getElementById(e.target.id).style.cursor = "pointer";
...
"SYSTEM.GLOBALS.CAREL.QUICKDYNAMICS.PVPRO Device HACCP Page":[function(base,webMI,window,document,self){
// ***** applying style="cursor:pointer" *****
webMI.addEvent(base.id, "mouseover", function(e)
{
	document.getElementById(e.target.id).style.cursor = "pointer";
...
"SYSTEM.GLOBALS.CAREL.QUICKDYNAMICS.PVPRO_boss Device Main Page":[function(base,webMI,window,document,self){
// ***** applying style="cursor:pointer" *****
webMI.addEvent(base.id, "mouseover", function(e)
{
	document.getElementById(e.target.id).style.cursor = "pointer";
...
"SYSTEM.GLOBALS.CAREL.QUICKDYNAMICS.PVPRO_boss Device Trend Page":[function(base,webMI,window,document,self){
// ***** applying style="cursor:pointer" *****
webMI.addEvent(base.id, "mouseover", function(e)
{
	document.getElementById(e.target.id).style.cursor = "pointer";
...
"SYSTEM.GLOBALS.CAREL.QUICKDYNAMICS.PVPRO_boss Device Alarms Page":[function(base,webMI,window,document,self){
// ***** applying style="cursor:pointer" *****
webMI.addEvent(base.id, "mouseover", function(e)
{
	document.getElementById(e.target.id).style.cursor = "pointer";
...
"SYSTEM.GLOBALS.CAREL.QUICKDYNAMICS.PVPRO_boss Device Parameters Page":[function(base,webMI,window,document,self){
// ***** applying style="cursor:pointer" *****
webMI.addEvent(base.id, "mouseover", function(e)
{
	document.getElementById(e.target.id).style.cursor = "pointer";
