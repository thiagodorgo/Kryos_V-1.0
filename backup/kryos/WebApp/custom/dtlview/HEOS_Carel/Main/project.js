...
webMI.addEvent(base.id, base.event, function(e) {
	...
	webMI.display.openWindow({display:base.display,extern:false,width:width,height:height,menubar:false,modal:modal,movable:moveable,resizable:resizeable,scrollbars:false,status:false,title:"",toolbar:false,x:xpos,y:ypos,query:passObj});
