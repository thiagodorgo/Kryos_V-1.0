...
<div class="tdfisa" style="text-align: left">
	<%=CurrUnit.getVariable("IR2").getDescription()%>
</div>
<div>
	<%
		String result = "";
		String fw_vers = CurrUnit.getVariable("IR2").getValue();
		if (!fw_vers.equals("***"))
		{
...
<div class="tdfisa" style="text-align: left">
	<%=CurrUnit.getVariable("IR5").getDescription()%>
</div>
<div>
	<%
		String netid_hex = "";
		String netid = CurrUnit.getVariable("IR5").getValue();
		if (!netid.equals("***"))
		{
			netid = netid.replaceFirst(",","");
			netid_hex = formatWordIntToHex(netid);
			netid_hex = netid_hex.toUpperCase();
		}
		else netid_hex = netid;
	%>
	<%= "<b class='lcdColor'>" + netid_hex + "</b>"%>
</div>
<div class="tdfisa" style="text-align: left">
	<%=macaddrTitle%>
</div>
<div>
	<%
		String macaddr_hex1 = "";
		String macaddr1 = CurrUnit.getVariable("IR4").getValue();
		if (!macaddr1.equals("***"))
		{
		...
		String macaddr_hex2 = "";
		String macaddr2 = CurrUnit.getVariable("IR3").getValue();
		if (!macaddr2.equals("***"))
		{
