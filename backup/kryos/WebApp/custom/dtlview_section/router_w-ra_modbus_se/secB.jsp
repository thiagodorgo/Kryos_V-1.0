...
<div>
	<%
		String macaddr_hex1 = "";
		String macaddr1 = CurrUnit.getVariable("IR6").getValue();
		if (!macaddr1.equals("***"))
		{
		...
		String macaddr_hex2 = "";
		String macaddr2 = CurrUnit.getVariable("IR5").getValue();
		if (!macaddr2.equals("***"))
		{
...
<div class="tdfisa" style="text-align: left">
	<%=CurrUnit.getVariable("HR6").getDescription()%>
</div>
<div>
	<%
		String channel = CurrUnit.getVariable("HR6").getValue();
	%>
	<%= "<b class='lcdColor'>" + channel + "</b>"%>
</div>
